...
public class Family {
    ...
    public boolean deleteChild(hw9.model.Human child){
    ...
    public String prettyFormat(){
        ...
        stringBuilder.append("   Mother: " + mother.prettyFormat() + ",\n");
        stringBuilder.append("   Father: " + father.prettyFormat() + ",\n");
        stringBuilder.append("   Children:\n");
        children.forEach(child->{
            if(child instanceof Man) stringBuilder.append("      boy: ");
            else stringBuilder.append("      girl: ");
            stringBuilder.append(child.prettyFormat() + "\n");
        });
        stringBuilder.append("   pets: " +getPet() + "\n");
